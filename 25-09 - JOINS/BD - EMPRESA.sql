...
SELECT nome, Cargo, 'Clientes' as tipo FROM clientes WHERE Pais = 'Brasil'
UNION ALL
SELECT nome, Cargo, 'Funcionarios' as tipo FROM Funcionarios

SELECT C.Descr, P.Descr FROM Categorias C CROSS JOIN Produtos
