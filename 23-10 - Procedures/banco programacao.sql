...
-- 1 - Se o funcionário de código 1 tiver 50 anos ou mais, aplique um aumento salarial de 50% e um bônus de R$ 500,00.
...
-- 2 - Se não, se o funcionário de código 1 tiver idade entre 40 e 49 anos, aplique um aumento salarial de 40% e um bõnus de R$ 1000,00.
...
-- 3 - Se não, se o funcionário de código 1 tiver idade entre 30 e 39 anos, aplique um aumento salarial de 30% e um bônus de R$ 1500,00.

-- 4 - Caso contrário, aplique um aumento de 20% e um bônus de R$ 2000,00.
